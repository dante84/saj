...
public class ActualizaAmparoAgrarioSegSP extends StoredProcedure
{
	private String param1  = "Aidregdoc"; 
	private String param2 = "Aexpinterno";
	private String param3 = "Aestatus";
	
	public ActualizaAmparoAgrarioSegSP(DataSource ds, String sNomSP)
	{
		super(ds, sNomSP);
	...
	public Map<String, Object> execute(int idreg, String expInterno, String estatus)
	{
		Map<String,Object> parametros = new HashMap<String, Object>();
		parametros.put(param1,idreg);
		parametros.put(param2,expInterno);
		parametros.put(param3,estatus);
