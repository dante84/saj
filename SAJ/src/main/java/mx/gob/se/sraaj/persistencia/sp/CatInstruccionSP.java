...
public class CatInstruccionSP extends StoredProcedure{
		
	    public CatInstruccionSP(DataSource ds, String sNomSP) {
		
	    	   super(ds, sNomSP);
		       logger.info(Constantes.MSG_LOG_CONSTRUCTOR + "CatInstruccionSP");
