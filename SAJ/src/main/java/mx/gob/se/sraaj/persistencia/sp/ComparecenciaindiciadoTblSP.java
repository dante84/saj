...
public class ComparecenciaindiciadoTblSP extends StoredProcedure
{
	private static String sParam1_sp = "Aidregdoc";
	
	public ComparecenciaindiciadoTblSP(DataSource ds, String sNomSP)
	{
		super(ds, sNomSP);
		declareParameter(new SqlParameter(sParam1_sp, OracleTypes.INTEGER));
		declareParameter(new SqlOutParameter(Constantes.OUT_SP_RESULTADO, OracleTypes.CURSOR, new ComparecenciaIndiciadoMapper()));
