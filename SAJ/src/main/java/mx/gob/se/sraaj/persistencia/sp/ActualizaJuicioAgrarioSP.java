...
public class ActualizaJuicioAgrarioSP extends StoredProcedure
{
	private String param1  = "Aidregdoc"; 
	private String param2 = "Aidmateria";
	private String param3 = "Aidtribunal";
	private String param4 = "fechaVencimiento";
	
	public ActualizaJuicioAgrarioSP(DataSource ds, String sNomSP)
	{
		super(ds, sNomSP);
	...
	public Map<String, Object> execute(int idreg, Integer idmateria, Integer idtribunal, Date fechaVenc)
	{
		Map<String,Object> parametros = new HashMap<String, Object>();
		parametros.put(param1,idreg);
		parametros.put(param2,idmateria);
		parametros.put(param3,idtribunal);
