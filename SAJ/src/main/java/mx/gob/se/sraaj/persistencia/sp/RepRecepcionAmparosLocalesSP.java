...
public class RepRecepcionAmparosLocalesSP extends StoredProcedure {
	
//	private static String sParam_sp = "pFecha";
	
	public RepRecepcionAmparosLocalesSP (DataSource ds, String sNomSP){
		super(ds, sNomSP);
...
//		declareParameter(new SqlParameter(sParam_sp, OracleTypes.DATE));
	...
	public Map<String, Object> execute(){
		System.out.println("========>> en SP.RecepcionAmparosLocales");
