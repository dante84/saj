...
public class CatTurnadoSP extends StoredProcedure  {
	
	private static String param1 = "tipoJuicio";
	
	public CatTurnadoSP(DataSource ds, String sNomSP){
		super(ds, sNomSP);				
	...
	public Map<String, Object> execute(int idTip) {
		
		Map<String,Object> parametros = new HashMap<String, Object>();
		
		System.out.println("En responsableSP idTipoJuicio = " + idTip );
		parametros.put(param1,idTip);
