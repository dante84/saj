...
@ManagedBean(name="CAsuntosJuridicosMinas")
@SessionScoped

public class ControladorMinas implements Serializable {
...
private static final long serialVersionUID = 1L;
	...
	private List<SeguimientoJuiciosBean> datosSeguimientoMinas;	
	public List<SeguimientoJuiciosBean> getDatosSeguimientoMinas() {return datosSeguimientoMinas;}
	public void setDatosSeguimientoMinas(List<SeguimientoJuiciosBean> datosSeguimientoMinas) {this.datosSeguimientoMinas = datosSeguimientoMinas;}
	...
	public String load() 
	{
		...
		txtBusqueda = null;			
		return CargarMinas("4");
	}
	
	public String CargarMinas(String TipJuc)
	{				
		llenaMateria();	
		llenaTabla(getFechaBusqueda(), getTxtBusqueda(), TipJuc);		
		txtBusqueda = null;
		fechaBusqueda = null;
		
		System.out.println(" =====>>>>>>>>>     " + turnados);		
		doMuestraTurnados();		
		System.out.println(" =====>>>>>>>>>     " + turnados);
	...
	public void llenaTabla(Date fecha, String txt, String idjuicio)
	{
		...
		try { sqlfecha = new java.sql.Date(fecha.getTime()); }
	...
	{
		llenaTabla(getFechaBusqueda(), null, "4");
		txtBusqueda = null;		
	}
	
	public void busquedaPorTexto()
	{
		llenaTabla(null, getTxtBusqueda(), "4");
		fechaBusqueda = null;
	}
	...
	//Getters and Setters en minas
	public String getMinas() { return minas;}
	public void setMinas(String minas) {this.minas = minas;}
	...
	public void doMuestraTurnados()  {		   		      	      		      		      	
		try {		
			setTurnados(gestionaCatDAOImpl.obtieneTurnados(4).toArray());
	...
	{
		System.out.println("Seguimiento en Minas.....");		
		llenaSeguimiento(null);
		return "seguimientoMinas";
	}
	...
	public void llenaSeguimiento(String txt)
	{
		try 
		{
			setDatosSeguimientoMinas(seguimientoDAOImpl.obtenerSeguimientoJuicios(txt,Integer.parseInt("4")));
		} 
		catch (SraajException e) 
		{		
			e.printStackTrace();
