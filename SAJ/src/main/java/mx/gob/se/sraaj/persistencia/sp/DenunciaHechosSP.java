...
import mx.gob.se.sraaj.persistencia.mapper.DenunciaHechosMapper;
...
public class DenunciaHechosSP extends StoredProcedure
{
	private static String sParam1_sp = "Aidregdoc";
	
	public DenunciaHechosSP(DataSource ds, String sNomSP)
	{
		super(ds, sNomSP);
		declareParameter(new SqlParameter(sParam1_sp, OracleTypes.INTEGER));
		declareParameter(new SqlOutParameter(Constantes.OUT_SP_RESULTADO, OracleTypes.CURSOR, new DenunciaHechosMapper()));
